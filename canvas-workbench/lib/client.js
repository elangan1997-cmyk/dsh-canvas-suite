...
const EXCALIDRAW_SRCDOC = `<!doctype html><html><head><meta charset="utf-8"><style>
    .dsh-name-layer{position:absolute;inset:0;z-index:55;pointer-events:none;overflow:hidden}.dsh-image-name-plain{position:absolute;box-sizing:border-box;user-select:none}
