...
- This compatibility branch targets DSH Desktop 2.0.4 plugin surfaces `0.1.2-alpha.1` and its embedded `@earendil-works/pi-ai` `0.84.3`. It is installed as a host-resolved plugin, so unpublished DSH internal packages are never downloaded or copied over the application runtime.
