...
完整 EXE 当前 r5 约 636 MB，超过 GitHub 普通仓库单文件 100 MB 限制，必须作为 Release asset 上传，不能 `git push` 到源码目录。插件 ZIP 也作为 Release asset 上传，源码仓库只保存脚本和说明。

Windows Preview.3 当前推荐资产：

- `DSH-Setup-x64-v0.1.1-rc.2-installer-r5.exe`
- `DSH-Setup-x64-v0.1.1-rc.2-installer-r5.exe.sha256`
