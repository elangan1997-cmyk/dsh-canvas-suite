...
当前 Windows Preview.3 推荐下载：

- [完整安装包 r5（约 636 MB）](https://github.com/elangan1997-cmyk/dsh-canvas-suite/releases/download/v1.4.0-windows-preview.3/DSH-Setup-x64-v0.1.1-rc.2-installer-r5.exe)
...
旧版 r4 仍保留在同一个 Release 中，可用于回滚。
本地构建输出位于仓库的 `dist/` 目录；该目录被 Git 忽略，不会上传到源码分支。
